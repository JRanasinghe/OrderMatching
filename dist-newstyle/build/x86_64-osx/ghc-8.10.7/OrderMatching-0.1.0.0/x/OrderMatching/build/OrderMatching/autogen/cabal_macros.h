...
/* package OrderMatching-0.1.0.0 */
#ifndef VERSION_OrderMatching
#define VERSION_OrderMatching "0.1.0.0"
#endif /* VERSION_OrderMatching */
#ifndef MIN_VERSION_OrderMatching
#define MIN_VERSION_OrderMatching(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_OrderMatching */
...
#define CURRENT_COMPONENT_ID "OrderMatching-0.1.0.0-inplace-OrderMatching"
